...
from .resonancehandler import ResonanceHandler
...
class Integrate:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.resonance_handler = resonance_handler        
    ...
    def integrate(self, t0: float, y0: np.ndarray) -> Tuple[np.ndarray, np.ndarray]:
        ...
        while t < self.tmax_dimensionless:
            ...
            t, y, spline_info = self.action_function(t, y, spline_info)
    ...
    def action_function(self, t: float, y: np.ndarray, spline_info):
        ...
        """
        if(self.resonance_handler != None):
            t, y, spline_info = self.resonance_handler.check_for_resonance_crossing(t, y, spline_info, self)
